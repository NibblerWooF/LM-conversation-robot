...
extern __attribute__((weak)) void audio_id3data(const char *);                                      
extern __attribute__((weak)) void audio_id3image(File &file, const size_t pos, const size_t size);  
extern __attribute__((weak)) void audio_id3lyrics(File &file, const size_t pos, const size_t size); 
